...
def main() -> None:  # noqa: C901, PLR0912, PLR0915
    ...
    lines += [
        ...
        "  subset from layer 0 onward, so the remaining caveat is hidden-state sequence",
        "  dependence, not a simple learned-position-table artifact. A larger fold-safe hidden-patch",
        "  run is still needed before treating this as a population estimate.",
